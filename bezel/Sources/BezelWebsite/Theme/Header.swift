...
struct Header: HTMLFileComponent {
    private let rightSideButtons = Node<Any>.raw("""
            <a href="/#features" class="text-m font-semibold leading-6 text-gray-900 dark:text-white hover:underline">Features</a>
            <a href="/pricing" class="text-m font-semibold leading-6 text-gray-900 dark:text-white hover:underline">Pricing</a>
            <a href="/vision" class="text-m font-semibold leading-6 text-gray-900 dark:text-white hover:underline">Vision Pro</a>
            <a href="/thank-you-for-trying-bezel" class="hidden sm:inline rounded-md ring-1 ring-purple-600 hover:bg-purple-600 hover:ring-purple-600 px-6 py-2 text-m font-semibold text-purple-600 dark:text-white hover:text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">                       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="inline-block w-6 h-6 mr-1 -mt-1">
