...
import { IntroEN, IntroFooterEN } from '@/components/IntroEN'
import { ThemeToggle } from '@/components/ThemeToggle'
import fireBackground from '@/images/fire-bg.jpg'
      ...
      >
        <defs>
          <pattern id={id} width="6" height="8" patternUnits="userSpaceOnUse">
            <path
              d="M0 0H6M0 8H6"
              className="stroke-orange-900/10 xl:stroke-white/10 dark:stroke-white/10"
              fill="none"
            />
          </pattern>
        </defs>
...
export function LayoutEN({ children }: { children: React.ReactNode }) {
  return (
    <>
      <FixedSidebar main={<IntroEN />} footer={<IntroFooterEN />} />
      <ThemeToggle />
