...
public extension Node where Context == HTML.DocumentContext {
    ...
    static func head<T: Website>(
        ...
        return .head(
            .encoding(.utf8),
            .siteName(site.name),
            .script(.defer(), .src("https://web.nonstrictmetrics.com/js/script.js"), .data(named: "domain", value: "nonstrict.eu"), .data(named: "api", value: "https://web.nonstrictmetrics.com/api/event")), // Add Plausible metrics
