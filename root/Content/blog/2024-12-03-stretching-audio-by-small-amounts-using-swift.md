---
date: 2024-12-03 12:00:00+01:00
slug: stretching-audio-by-small-amounts-using-swift
title: Stretching audio by small amounts using Swift
description: Stretching an audio file to a certain length can be useful to fix lipsync
  issues. Our previous approach didn't work for stretching small durations over a
  large amount of time. We now have a new solution.
authors:
- tom
- mathijs
tags:
