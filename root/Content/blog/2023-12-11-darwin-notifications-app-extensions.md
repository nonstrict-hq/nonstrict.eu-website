---
date: 2023-12-11 12:00:00+01:00
slug: darwin-notifications-app-extensions
title: Using Darwin Notifications to communicate with App Extensions
description: On iOS, Darwin Notifications can be used to send and receive notifications
  between an app and its extensions. We wrap the old C-style functions to be easier
  to use from Swift.
authors:
- tom
- mathijs
