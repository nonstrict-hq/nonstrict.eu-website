---
date: 2025-02-20 12:00:00+01:00
slug: distorted-audio-avcapturesession
title: Distorted Audio when recording external microphones using AVCaptureSession
description: In certain situations, when recording audio on macOS using AVCaptureSession
  and AVAssetWriter, the resulting audio file can sound distorted. This issue is caused
  by AVCaptureSession reporting CMSampleBuffers of different audio formats.
authors:
- tom
- mathijs
tags:
