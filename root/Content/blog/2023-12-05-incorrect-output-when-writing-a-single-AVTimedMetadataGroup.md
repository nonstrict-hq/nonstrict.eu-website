---
date: 2023-12-04 12:00:00+01:00
slug: incorrect-output-when-writing-a-single-AVTimedMetadataGroup
title: Incorrect output when writing a single AVTimedMetadataGroup
description: Timed metadata can be written to a track using AVAssetWriter. However
  if you append only one AVTimedMetadataGroup the results will be unexpected due to
  buggy behaviour.
authors:
- mathijs
- tom
