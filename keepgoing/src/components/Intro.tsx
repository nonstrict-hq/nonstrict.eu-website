  ...
  return (
    <>
      ...
      <h1 className="mt-14 font-display text-4xl/tight font-light text-white">
        ...
        <span className="text-emerald-500">focus on your goal</span>
      </h1>
      <p className="mt-4 text-sm/6 text-gray-300">
        Keep Going is a workout app for Apple Watch and iPhone with a simplistic interface. Showing the progress towards your workout goal without any distractions.
      </p>
      <a href="https://apps.apple.com/nl/app/keep-going-fitness-cardio/id6482290117">
        <Image className="mt-6" src={appStoreBadge} alt="Download on the App Store" width={120} height={40} />
      </a>
    </>
  )
}
...
export function IntroFooter() {
  return (
    <p className="text-[0.8125rem]/6 text-gray-500">
      Brought to you by <a href="https://nonstrict.eu/">Nonstrict</a> & <a href="https://visio.org/keepgoing">Visio</a>.
    </p>
  )
}
